...
<body>
    ...
    <div class="selectionContainer fadeUp" id="selectionContainer">
        ...
        <div class="difficultyCards">
            <div class="difficultyCard mudah fadeUp" onclick="startQuiz('Mudah')" style="cursor: pointer;">
                <h3>Mudah</h3>
            ...
            <div class="difficultyCard sedang fadeUp" onclick="startQuiz('Sedang')" style="cursor: pointer;">
                <h3>Sedang</h3>
            ...
            <div class="difficultyCard sulit fadeUp" onclick="startQuiz('Sulit')" style="cursor: pointer;">
                <h3>Sulit</h3>
    ...
    <div class="quizContainer" id="quizContainer" style="display: none;">
        ...
        <button class="btn-back-selection" onclick="backToSelection()">← Kembali ke Pilihan Tingkat</button>
        ...
        <div class="resultsContainer" id="resultsContainer">
            ...
            <div>
                <button class="restartBtn" onclick="restartQuiz()">Ulangi Quiz</button>
                <a href="<?= site_url('landing_logged') ?>" class="homeBtn">Kembali ke Beranda</a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        window.startQuiz = function(difficulty) {
            console.log('startQuiz called with difficulty:', difficulty);
            
            if (!allQuestions || allQuestions.length === 0) {
                alert('Data pertanyaan belum siap. Tunggu sebentar atau refresh halaman.');
                return;
            }
            ...
            if (filteredQuestions.length === 0) {
                alert('Tidak ada pertanyaan untuk tingkat kesulitan ini.');
                return;
            }
        ...
        function backToSelection() {
            ...
            const questionCards = quizContainer.querySelectorAll('.questionCard');
            questionCards.forEach(card => card.remove());
            document.querySelector('.btn-back-selection').style.display = 'block';
            window.scrollTo({ top: 0, behavior: 'smooth' });
        }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            fadeItems.forEach((item, index) => {
                ...
                // Trigger hero content immediately (position: absolute elements)
