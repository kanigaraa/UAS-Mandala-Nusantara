        ...
        <div class="card p-5">
            ...
            <?= form_open_multipart('admin/update_rekomendasi'); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="id_kerajaan" value="<?= $rekomendasi['id_kerajaan'] ?>">
                    <input type="number" class="form-control" value="<?= $rekomendasi['id_kerajaan'] ?>" readonly style="background-color: #f0f0f0; cursor: not-allowed;">
