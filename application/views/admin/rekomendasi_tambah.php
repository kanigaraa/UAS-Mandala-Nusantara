...
<body>
    ...
    <div class="container">
        <div class="card p-5">
            <h2 class="mb-4 text-center">Tambah Data Rekomendasi Kerajaan</h2>
            ...
            <?= form_open_multipart('admin/simpan_rekomendasi'); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="id_kerajaan" class="form-control" required placeholder="Contoh: 1, 2, 3...">
                    <small class="text-muted">*ID unik untuk kerajaan rekomendasi ini (Primary Key).</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="gambar" class="form-control-file" required accept=".png, .jpg, .jpeg">
